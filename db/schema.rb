...
ActiveRecord::Schema[7.0].define(version: 2025_01_31_054215) do
  ...
  create_table "favorites", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["column_id"], name: "index_favorites_on_column_id"
  ...
  create_table "recipe_ingredients", charset: "utf8", force: :cascade do |t|
  ...
  add_foreign_key "favorites", "columns"
